...
async function getHtmlJson(){
    ...
    for(let i = 0 ; i < 10; i++){
        ...
        flightListingBox.innerText += JSON.stringify(html[i], null, 4 );
        ...
        flightDeparture = JSON.stringify(html[i][5].departure.length, null, 4 );

        console.log("flight Departure length " + flightDeparture)
